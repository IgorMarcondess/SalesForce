                ...
                <div className="flex flex-col justify-center">
                  <div className="p-5 bg-gray-300 flex flex-col rounded-lg border-2 border-gray-800 shadow-[8px_6px_0px_0px] shadow-gray-800">
                    <div className="flex justify-between">
                      <h1 className="text-gray-800 font-extrabold text-xl">{item.email}</h1>
                      <p className="text-gray-800 font-extrabold text-xl">{item.probabilidadeContratacao}%</p>
                    </div>
                    <div className="flex justify-between">
                      <p className="text-gray-500 font-semibold text-lg">{item.cargo}</p>
                      <p className="text-gray-500 font-semibold text-lg">{item.tipoEmpresa}</p>
                      <p className="text-gray-500 font-semibold text-lg">{item.setor}</p>
                    </div>
                  </div>
                </div>
              ))}
